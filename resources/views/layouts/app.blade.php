...
<body class="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-200 font-sans transition-colors duration-300" 
    ...
    @php
        $socialLinks = [
            ...
            ['name' => 'TikTok', 'icon' => 'M12 2a1 1 0 0 0-1 1v12.5a1.5 1.5 0 1 1-3-1.5c.01 0 .02 0 .03 0V11a4.5 4.5 0 1 0 5.47 5.47V7a7.5 7.5 0 0 0 5.5 2.5v-3a4.5 4.5 0 0 1-4-2V2h-2z', 'color' => 'gray'],
    ...
    @endphp
    <footer class="hidden lg:block bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 mt-20 lg:mt-32 relative overflow-hidden transition-colors duration-300">
    ...
    <footer class="lg:hidden bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-gray-900 overflow-hidden relative">
        <div class="px-6 space-y-6">
            ...
            <div class="flex gap-3">
                <a href="{{ route('terms') }}" class="flex-1 flex items-center gap-3 bg-gray-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 active:scale-95 transition-transform">
                    ...
                    <span class="text-[10px] font-black uppercase tracking-widest text-gray-900 dark:text-white">Conditions</span>
                </a>
                <a href="{{ route('privacy') }}" class="flex-1 flex items-center gap-3 bg-gray-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 active:scale-95 transition-transform">
                    ...
                    <span class="text-[10px] font-black uppercase tracking-widest text-gray-900 dark:text-white">Vie Privée</span>
                </a>
            </div>
        </div>
    </footer>
