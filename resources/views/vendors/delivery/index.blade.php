...
<div class="space-y-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="lg:col-span-1 space-y-10">
            <div class="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-xl border border-gray-100 dark:border-gray-800">
                    ...
                    <div class="space-y-4">
                        @foreach($applications as $app)
                            @if($app->status === 'pending')
                                <div class="flex items-center gap-6 p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700/50">
