...
<div class="max-w-6xl mx-auto" x-data="{ activeTab: 'general' }">
    <div class="mb-6">
        <h1 class="text-xl font-black text-gray-900 tracking-tight">Configuration Système</h1>
    ...
    <div class="flex flex-col lg:flex-row gap-10">
        ...
        <aside class="w-full lg:w-72 space-y-2">
            ...
            <button 
                ...
                class="w-full flex items-center justify-between px-4 py-4 rounded-lg transition-all group overflow-hidden relative">
                                ...
                                <div class="relative">
                                    ...
                                    @elseif($setting->type === 'password')
                                        <input type="password" name="{{ $setting->key }}" id="{{ $setting->key }}" value="{{ $setting->value }}"
                                            class="w-full px-4 py-4 bg-gray-50 border-2 border-transparent rounded-lg font-bold text-gray-900 focus:bg-white focus:border-red-500 outline-none transition-all shadow-sm">
