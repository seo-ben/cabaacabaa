...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-black text-gray-900 tracking-tight leading-none uppercase">Nouveau Plan</h1>
            <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-1.5">Création d'un nouveau palier tarifaire</p>
        </div>
    </div>

    <form action="{{ route('admin.subscriptions.store') }}" method="POST" class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        @csrf
        ...
        <div class="p-8 space-y-6">
            <div class="grid grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" class="w-full px-4 py-3 bg-gray-50 border-none rounded-2xl text-[11px] font-bold focus:ring-2 focus:ring-orange-500/20" placeholder="ex: Ultra" required>
                </div>
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Prix (FCFA)</label>
                    <input type="number" name="price" class="w-full px-4 py-3 bg-gray-50 border-none rounded-2xl text-[11px] font-bold focus:ring-2 focus:ring-orange-500/20" placeholder="0" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="number" name="product_limit" value="5" class="w-full px-4 py-3 bg-gray-50 border-none rounded-2xl text-[11px] font-bold focus:ring-2 focus:ring-orange-500/20" required>
                </div>
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Limite Staff</label>
                    <input type="number" name="staff_limit" value="1" class="w-full px-4 py-3 bg-gray-50 border-none rounded-2xl text-[11px] font-bold focus:ring-2 focus:ring-orange-500/20" required>
                </div>
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Coupons Max</label>
                    <input type="number" name="coupon_limit" value="0" class="w-full px-4 py-3 bg-gray-50 border-none rounded-2xl text-[11px] font-bold focus:ring-2 focus:ring-orange-500/20" required>
                </div>
            </div>
            ...
            <div class="space-y-4 pt-4">
                ...
                <div class="space-y-3">
                    <label class="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl cursor-pointer group hover:bg-gray-100 transition-all">
                        <input type="checkbox" name="has_gallery" value="1" class="w-5 h-5 rounded-lg border-gray-200 text-orange-600 focus:ring-orange-500/20">
                        <div class="flex-1">
                    ...
                    <label class="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl cursor-pointer group hover:bg-gray-100 transition-all">
                        <input type="checkbox" name="has_socials" value="1" class="w-5 h-5 rounded-lg border-gray-200 text-orange-600 focus:ring-orange-500/20">
                        <div class="flex-1">
                    ...
                    <label class="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl cursor-pointer group hover:bg-gray-100 transition-all">
                        <input type="checkbox" name="is_boosted" value="1" class="w-5 h-5 rounded-lg border-gray-200 text-orange-600 focus:ring-orange-500/20">
                        <div class="flex-1">
                    ...
                    <label class="flex items-center gap-3 p-4 bg-gray-100 rounded-2xl cursor-pointer group hover:bg-emerald-50 transition-all">
                        <input type="checkbox" name="can_recruit_drivers" value="1" class="w-5 h-5 rounded-lg border-gray-200 text-emerald-600 focus:ring-emerald-500/20">
                        <div class="flex-1">
