...
<div class="space-y-8">
    ...
    <!-- Filters -->
    <div class="bg-white p-4 rounded-lg border border-gray-100 shadow-sm flex flex-col md:flex-row gap-4">
        <form action="{{ route('admin.finance.transactions') }}" method="GET" class="flex-1 flex gap-4">
            ...
            <button type="submit" class="px-4 py-2 bg-slate-900 text-white rounded-xl font-bold text-sm">Filtrer</button>
            @if($search)
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-gray-50/50">
                        <th class="px-5 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">ID / REF</th>
                        <th class="px-5 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Date</th>
                        <th class="px-5 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Type</th>
                        ...
                        <th class="px-5 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Commande</th>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50 transition">
                        ...
                        <td class="px-5 py-4 text-right lg:text-left">
