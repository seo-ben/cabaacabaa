...
<div class="space-y-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-xl font-black text-gray-900 tracking-tight">Catégories de Boutiques</h1>
        ...
        <a href="{{ route('admin.vendor-categories.create') }}" class="px-5 py-4 bg-orange-600 text-white rounded-[1.5rem] font-black shadow-xl shadow-orange-200 hover:bg-orange-700 transition flex items-center gap-3 active:scale-95">
    ...
    @if(session('success'))
        <div class="p-4 bg-green-50 border border-green-100 rounded-[2rem] text-green-600 font-bold flex items-center justify-between animate-fade-in">
    ...
    @if(session('error'))
        <div class="p-4 bg-red-50 border border-red-100 rounded-[2rem] text-red-600 font-bold flex items-center justify-between animate-fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        @forelse($categories as $category)
            <div class="bg-white p-5 rounded-[2.5rem] border border-gray-100 shadow-sm relative overflow-hidden group hover:border-orange-500 transition-all">
                <div class="flex items-start justify-between">
                    <div class="w-12 h-12 bg-orange-50 rounded-[1.5rem] flex items-center justify-center text-xl group-hover:scale-110 transition-transform text-orange-600">
                ...
                <div class="mt-5 flex items-center justify-between border-t border-gray-50 pt-6">
        ...
        @empty
            <div class="col-span-full py-32 bg-white rounded-[3rem] border-2 border-dashed border-gray-100 text-center">
                <div class="w-16 h-16 bg-gray-50 rounded-[2rem] flex items-center justify-center mx-auto mb-5 text-gray-200">
                ...
                <a href="{{ route('admin.vendor-categories.create') }}" class="mt-5 inline-block px-10 py-4 bg-orange-600 text-white rounded-lg font-black uppercase tracking-widest text-[11px] shadow-xl shadow-orange-200 hover:bg-black transition-all">Ajouter une catégorie</a>
            </div>
        @endforelse
    </div>
</div>
