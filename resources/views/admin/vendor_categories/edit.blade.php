        ...
        <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-8">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="4"
                          class="w-full px-5 py-5 bg-gray-50 border-0 rounded-2xl focus:bg-white focus:ring-4 focus:ring-orange-500/10 outline-none transition-all text-sm font-bold text-gray-900 resize-none">{{ old('description', $category->description) }}</textarea>
