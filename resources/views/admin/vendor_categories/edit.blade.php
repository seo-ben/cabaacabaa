...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-xl font-black text-gray-900 tracking-tight mt-4">Modifier : {{ $category->name }}</h1>
    </div>
        ...
        <div class="bg-white p-4 rounded-[3rem] border border-gray-100 shadow-sm space-y-8">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="4"
                          class="w-full px-5 py-5 bg-gray-50 border-0 rounded-[2rem] focus:bg-white focus:ring-4 focus:ring-orange-500/10 outline-none transition-all text-sm font-bold text-gray-900 resize-none">{{ old('description', $category->description) }}</textarea>
